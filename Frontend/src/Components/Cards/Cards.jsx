    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 justify-center gap-4 m-6 p-6 md:px-8 md:py-6 lg:mx-40 lg:p-30'>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
            <div className="h-64 relative">
                  ...
                  {/* <button className='mr-4 justify-items-end absolute bottom-2 right-2 text-xl' key={item.id} onClick={() => handleClick(item.id)}>
                     <svg className='mr-4 justify-items-end absolute bottom-2 right-2 text-yellow-500 text-xl' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>
                </button> */}
            </div>
            <div className="p-4">
         ...
         {/* <button className='bottom-2 right-2 text-xl' key={item.id} onClick={() => handleClick(item.id)}>
            <svg className='bottom-2 right-2 text-yellow-500 text-xl' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>
          </button> */}
