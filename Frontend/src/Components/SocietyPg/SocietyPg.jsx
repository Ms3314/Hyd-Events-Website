    ...
    <div>
       <div className='grid lg:grid-cols-3 grid-cols-1 flex'>
          ...
          <div className='bg-blue-50 box-content text-black p-4 rounded-lg shadow-lg h-80 m-5'>
            ...
            <div className='font-semibold text-xl top-0 p-1 left-0 text-black rounded-tr-lg whitespace-nowrap'>Team Size
            ...
            <div className='font-medium text-xl p-1 top-0 left-0 text-black rounded-tr-lg whitespace-nowrap'>DeadLine
