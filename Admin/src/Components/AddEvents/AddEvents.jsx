...
const AddEvents = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center '>
      <Toaster />
      <div className="flex flex-col bg-white justify-center items-center w-[60%]  mx-auto m-10 rounded-lg">
      ...
      >
        <div className="flex flex-col space-y-4">
          ...
          <label htmlFor="Deadline event">Deadline for event</label>
          <input
              className="border-2 rounded-lg p-2 w-full"
              type="date"
      ...
      <div className="w-full mt-10">
        <div className="flex flex-col w-full  ">
            ...
            <div className="bg-white rounded-lg  shadow-lg p-6 mb-6">
              <div className="flex flex-col gap-3">
                <div className="w-full md:w-2/3 md:pl-6">
                  <h2 className="text-2xl font-bold mb-3 text-gray-800">{data?.title}</h2> 
                  {/* <h3 className="text-lg text-gray-600 mb-4">{data?.EventType} by {data?.organisation[0].name} </h3> */}
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center text-gray-700">
                      ...
                      <span>{data?.venue == "" ? "Nothing yet" :data?.venue }</span>
                    </div>
